...
public class RequeryRepositoryFactory extends RepositoryFactorySupport {
    ...
    public RequeryRepositoryFactory(@NotNull RequeryOperations operations) {
    ...
    @SuppressWarnings("unchecked")
    @NotNull
    public <T, ID> RequeryEntityInformation<T, ID> getEntityInformation(@NotNull Class<T> domainClass) {
